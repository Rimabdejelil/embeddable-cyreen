...
const DropdownDimensionNames = ({ dimensionNames, onChange }: Props) => {
    const [selectedName, setSelectedName] = useState('');

    useEffect(() => {
        // Reset selection if dimensionNames change and the current selection is no longer valid
        if (!dimensionNames.includes(selectedName)) {
            setSelectedName('');
        }
    }, [dimensionNames, selectedName]);
